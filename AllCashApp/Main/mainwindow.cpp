...
void MainWindow::on_pushButton_clicked() {
  ...
  connect(accountWindow, &Account::accountWindowClosed, this,
...
void MainWindow::on_pushButtonCredits_clicked() {
  ...
  if (fm.isCreditOpened()) {
    ...
    connect(creditsWindow, &Credits::creditsWindowClosed, this,
            &MainWindow::showMainWindow);
    ...
    connect(openCreditWindow, &OpenCredit::openCreditsWindowClosed, this,
            &MainWindow::showCreditsWindow);
...
void MainWindow::on_pushButton_2_clicked() { on_pushButtonCredits_clicked(); }
...
void MainWindow::on_pushButton_3_clicked() {
  ...
  if (fm.isDepositOpened()) {
    ...
    connect(depositWindow, &Deposit::depositWindowClosed, this,
            &MainWindow::showMainWindow);
    ...
    connect(openDepositWindow, &OpenDeposit::openDepositWindowClosed, this,
            &MainWindow::showDepositWindow);
